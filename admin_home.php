		...
		<div class="container-fluid">
			<div class="row justify-content-start">
				<div class="col-xs-6 col-sm-8 col-lg-6 col-xl-6  box" style="width:100%;height:45rem">
					<div style="font-family: 'Raleway', sans-serif; color: black;font-size: 30px;">
					<?php
			...
			<p style='text-align: right'>
				Date: <input class="btn btn-success" type="date" name="defence_date">
				<button class="btn btn-success" type="submit" name="defence_deadline">Change Date</button>
				</p>
				</form> </div> <br>
					</form>
				</div>
				...
				<div class="container-fluid">
					<div class="row justify-content-start">
						...
						<form action="admin_server.php" method="POST">
						<p style='text-align: right'>
						Date: <input  class="btn btn-warning" type="date" name="internal_date">
						<button  class="btn btn-warning" type="submit" name="internal_deadline">Change Date</button>
						</p>
						</form> </div> <br>
								</form>
							</div>
